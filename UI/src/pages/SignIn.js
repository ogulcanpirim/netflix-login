      ...
      <div className="App">
        ...
        <div className="loginForm">
          ...
          <form autoComplete="off" onSubmit={handleSubmit}>
            <div className="inputGroup">
              <div className="inputContainer" style={{ borderBottom: errorEmail ? "3px solid #e87c03" : "none" }}>
                <input
                  ...
                  noValidate=""
                />
                <label className="form-label" htmlFor="email_phone">
            ...
            <button id="login-submit" disabled={loading} type="submit" formNoValidate>
              {loading ? <Spinner style={{ margin: "auto" }} /> : "Oturum Aç"}
            </button>
